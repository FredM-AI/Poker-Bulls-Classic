...
export default function PlayersPage() {
  ...
  const visiblePlayers = (players ?? []).filter((p) => isAuthenticated || p.isActive)
                ...
                <TableBody>
                  {sortedPlayers.map((player) => (
                    <TableRow key={player.id}>
                      ...
                      {isAuthenticated && (
                        <>
                          <TableCell className="text-xs text-muted-foreground py-1 px-4">
                      ...
                      <TableCell className="text-right space-x-2 py-1 px-4">
                        ...
                        {isAdmin && (
                          <>
                            ...
                            <DeletePlayerButton playerId={player.id} playerName={getPlayerDisplayName(player)} />
                          </>
                        )}
                      </TableCell>
                    </TableRow>
