...
const SeasonCard = ({ season, associatedEvents, leaderboard, isAuthenticated, isAdmin }: { season: Season, associatedEvents: EventType[], leaderboard: LeaderboardEntry[], isAuthenticated: boolean, isAdmin: boolean }) => {
