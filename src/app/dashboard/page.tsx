...
export default function DashboardPage() {
    ...
    React.useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const userRole = authCookie ? authCookie.split('=')[1] : null;
                ...
                // We keep data as null or set partially if needed, but simple console.error is required
            } finally {
                setIsLoading(false);
            }
        };
    ...
    const { currentSeason, nextSeason, allPlayers, seasonStats, seasonEvents, userRole } = data;
    const isAdmin = userRole === 'admin';
    const isAuthenticated = userRole === 'admin' || userRole === 'floor_manager';
