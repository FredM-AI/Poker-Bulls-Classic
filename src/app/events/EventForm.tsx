...
export default function EventForm({ event, allPlayers, allSeasons, blindStructures, action, formTitle, formDescription, submitButtonText, defaultSeasonId }: EventFormProps) {
  ...
  React.useEffect(() => {
    ...
    React.useEffect(() => {
        ...
        // Do not auto-calculate if there are manual prizes entered from a previous edit
        // This is a simple check; a more robust solution might use a separate state flag.
        ...
        if (numParticipants >= 15) {
            ...
            } else { // Fallback if 4th prize is larger than pool (edge case)
