import type { BlindStructureTemplate } from '@/lib/types'
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Starting Stack: {structure.startingStack ? structure.startingStack.toLocaleString() : 'N/A'}</DialogDescription>
        </DialogHeader>
